...
namespace Notes {
	void CreationForm::InitializeComponent(void)
	{
	...
	System::Void CreationForm::CreationForm_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void CreationForm::colorpickerBtn_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void CreationForm::cancelBnt_Click(System::Object^ sender, System::EventArgs^ e) {
		this->Close();
	}

	System::Void CreationForm::headerTextBox_Enter(System::Object^ sender, System::EventArgs^ e) {
		removeHintFromTextBox(headerTextBox, Color::Red);
	}

	System::Void CreationForm::headerTextBox_Leave(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void CreationForm::topicTextBox_Enter(System::Object^ sender, System::EventArgs^ e) {
		removeHintFromTextBox(topicTextBox, Color::Gray);
	}

	System::Void CreationForm::topicTextBox_Leave(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void CreationForm::bodyTextBox_Enter(System::Object^ sender, System::EventArgs^ e) {
		removeHintFromTextBox(bodyTextBox, Color::Gray);
	}

	System::Void CreationForm::bodyTextBox_Leave(System::Object^ sender, System::EventArgs^ e) {
		setHintToTextBox(bodyTextBox, "Введите содержание", Color::Gray);
	}

	System::Void CreationForm::createBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		if (String::IsNullOrWhiteSpace(headerTextBox->Text))
			return;
	...
	System::Void CreationForm::headerTextBox_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void CreationForm::topicTextBox_TextChanged(System::Object^ sender, System::EventArgs^ e) {
