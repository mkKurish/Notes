...
namespace Notes {
	...
	System::Void MainForm::updateNotesDataMainForm() {
	...
	System::Void MainForm::createBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		CreationForm cform;
		cform.ShowDialog();
		updateNotesDataMainForm();
	}

	System::Void MainForm::deleteBtn_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::faqBtn_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::notesListBox_DrawItem(System::Object^ sender, System::Windows::Forms::DrawItemEventArgs^ e) {
		if (e->Index == -1)
			return;
		// Tuple of next values: header, body, topic name, topic color, time, index in mainList
	...
	System::Void MainForm::notesListBox_MeasureItem(System::Object^ sender, System::Windows::Forms::MeasureItemEventArgs^ e) {
		Drawing::Font^ headerFont = gcnew Drawing::Font("Microsoft Sans Serif", 11, FontStyle::Bold);
		Drawing::Font^ bodyFont = gcnew Drawing::Font("Microsoft Sans Serif", 9, FontStyle::Regular);
		Drawing::SizeF^ headerSize = gcnew Drawing::SizeF();
		Drawing::SizeF^ bodySize = gcnew Drawing::SizeF();
	...
	System::Void MainForm::notesListBox_Resize(System::Object^ sender, System::EventArgs^ e) {
		notesListBox->Invalidate();
	}

	System::Void MainForm::notesListBox_DoubleClick(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::byDate_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::byTopic_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::choosingTopicsItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	System::Void MainForm::clearChosenTopics(System::Object^ sender, System::EventArgs^ e) {
